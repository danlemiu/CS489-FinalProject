...
INSERT into USER (user_id, firstName, lastName, username, email, password, active, address_id) values (1, 'Qan', 'Tuong', 'admin', 'qantuongth@gmail.com', '$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.', 1, 1);
INSERT into USER (user_id, firstName, lastName, username, email, password, active, address_id) values (2, 'Tu', 'Le', 'seller', 'ttle@miu.edu','$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.', 1, 2);
INSERT into USER (user_id, firstName, lastName, username, email, password, active, address_id) values (3, 'Mui', 'Truong', 'buyer', 'muitruong@miu.edu','$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.', 1, 3);
INSERT into USER (user_id, firstName, lastName, username, email, password, active, address_id) values (4, 'Van', 'Le', 'tuseller','tnle@miu.edu', '$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.', 1, 4);
INSERT into USER (user_id, firstName, lastName, username, email, password, active, address_id) values (5, 'Ka', 'Truong', 'katruong','katruong@miu.edu',  '$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.', 1, 5);
INSERT into USER (user_id, firstName, lastName, username, email, password, active, address_id) values (6, 'Dan', 'Le', 'danbuyer','danle@miu.edu', '$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.', 1, 6);
