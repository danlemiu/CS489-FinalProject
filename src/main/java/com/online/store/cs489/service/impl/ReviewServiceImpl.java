...
import com.online.store.cs489.service.ReviewService;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    public Response approveReview(Long reviewId) {
       ...
       reviewRepository.save(review);
        ...
        stringBuilder.append("It's now available on our store. Please check it out at %s. <br/><br/> Thank you so much<br/><br/>");
