...
import com.online.store.cs489.domain.RoleType;
import com.online.store.cs489.domain.User;
import com.online.store.cs489.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public void sendEmailRegisterUser(Long userId) {
        ...
        if (role != null && role.getRole() == RoleType.ROLE_BUYER) {
            ...
            stringBuilder.append("Please login at %s <br/><br/> Thank you so much. <br/><br/>");
            ...
            stringBuilder.append("Please wait for Admin's approval then login at %s. <br/><br/> Thank you so much. <br/><br/>");
    ...
    public void sendEmailApprovalSeller(Long userId) {
        ...
        if (role != null && role.getRole() == RoleType.ROLE_SELLER) {
            stringBuilder.append("Your registration to be a seller has just approved<br/><br/>");
            stringBuilder.append("Now you can login at %s and sell your products. <br/><br/> Thank you so much.<br/><br/>");
